...
class Article(models.Model):
    ...
    author = models.ForeignKey(Blogger, related_name='blog_author', on_delete=models.PROTECT, max_length=40,  verbose_name='Автор')
...
class Comment(models.Model):
    comment_to_article = models.ForeignKey(Article, on_delete=models.CASCADE, null=True, blank=True, related_name='article_comm', verbose_name="Комментарий к статье")
    comment_to_comment = models.ForeignKey('self', on_delete=models.CASCADE, null=True, blank=True, related_name='comment', verbose_name="Комментарий к комментарию")
    author = models.ForeignKey(Blogger, on_delete=models.PROTECT, max_length=40, related_name='blogger_comm',  verbose_name='Автор')
...
class Favorite(models.Model):
    user = models.ForeignKey(Blogger, related_name='blogger_fav',on_delete=models.PROTECT)
    article = models.ForeignKey(Article, related_name='article_fav',on_delete=models.PROTECT)
